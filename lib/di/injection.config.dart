...
import '../modules/login/presentation/bloc/login_bloc.dart' as _i36;
import '../modules/moment/domain/repository/moment_repository.dart' as _i37;
import '../modules/moment/domain/use_case/delete_moments_use_case.dart' as _i45;
import '../modules/moment/domain/use_case/get_moments_use_case.dart' as _i34;
import '../modules/moment/domain/use_case/register_moments_use_case.dart'
    as _i40;
import '../modules/moment/domain/use_case/update_moment_use_case.dart' as _i43;
...
import '../modules/moment/infra/repository/register_moment_repository_impl.dart'
    as _i38;
import '../modules/moment/presenter/bloc/add_or_edit_moment_bloc.dart' as _i44;
...
import '../modules/photos/domain/use_case/delete_all_photos_from_moment_use_case.dart'
    as _i31;
import '../modules/photos/domain/use_case/delete_photo_use_case.dart' as _i32;
import '../modules/photos/domain/use_case/get_media_use_case.dart' as _i33;
...
import '../modules/photos/presentation/bloc/photos_bloc.dart' as _i39;
import '../modules/signup/domain/sign_up_use_case.dart' as _i27;
import '../modules/signup/presentation/bloc/sign_up_bloc.dart' as _i42;
...
import '../modules/time_line/infra/data_source/time_line_data_source.dart'
    as _i13;
import '../modules/time_line/infra/model/time_line_model.dart' as _i5;
import '../modules/time_line/infra/repository/time_line_repository_impl.dart'
    as _i29;
import '../modules/time_line/presenter/bloc/select_time_line_bloc.dart' as _i41;
import '../modules/time_line/presenter/bloc/time_line_bloc.dart' as _i46;
import 'modules/app_modules.dart' as _i48;
import 'modules/firebase_modules.dart' as _i47;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i3.CollectionReference<_i5.TimeLineModel>>(
  ...
  gh.factory<_i13.TimeLineDataSource>(() =>
      _i13.FirebaseTimelineRemoteDataSourceImpl(
          gh<_i3.CollectionReference<_i5.TimeLineModel>>(
              instanceName: 'timeline')));
  ...
  gh.factory<_i28.TimeLineRepository>(() => _i29.TimeLineRepositoryImpl(
        dataSource: gh<_i20.MomentsDataSource>(),
  ...
  gh.factory<_i32.DeletePhotoUseCase>(
      () => _i32.DeletePhotoUseCase(gh<_i24.PhotosRepository>()));
  gh.factory<_i33.GetMediaUseCase>(
      () => _i33.GetMediaUseCase(gh<_i24.PhotosRepository>()));
  gh.factory<_i34.GetMomentsUseCase>(
      () => _i34.GetMomentsUseCase(gh<_i28.TimeLineRepository>()));
  gh.factory<_i35.GetTimeLineFromEmailUseCase>(
      () => _i35.GetTimeLineFromEmailUseCase(
  ...
  gh.factory<_i37.MomentRepository>(
      () => _i38.MomentRepositoryImpl(gh<_i20.MomentsDataSource>()));
  gh.factory<_i39.PhotosBloc>(
      () => _i39.PhotosBloc(gh<_i33.GetMediaUseCase>()));
  gh.factory<_i40.RegisterMomentsUseCase>(
      () => _i40.RegisterMomentsUseCase(gh<_i37.MomentRepository>()));
  gh.factory<_i41.SelectTimeLineBloc>(() => _i41.SelectTimeLineBloc(
        gh<_i35.GetTimeLineFromEmailUseCase>(),
        gh<_i19.LogoutUseCase>(),
      ));
  gh.factory<_i42.SignUpBloc>(() => _i42.SignUpBloc(gh<_i27.SignUpUseCase>()));
  gh.factory<_i43.UpdateMomentUseCase>(
      () => _i43.UpdateMomentUseCase(gh<_i37.MomentRepository>()));
  gh.factory<_i44.AddOrEditMomentBloc>(() => _i44.AddOrEditMomentBloc(
        gh<_i43.UpdateMomentUseCase>(),
        gh<_i40.RegisterMomentsUseCase>(),
        gh<_i30.UploadPhotoUseCase>(),
        gh<_i32.DeletePhotoUseCase>(),
      ));
  gh.factory<_i45.DeleteMomentsUseCase>(
      () => _i45.DeleteMomentsUseCase(gh<_i37.MomentRepository>()));
  gh.factory<_i46.TimeLineBloc>(() => _i46.TimeLineBloc(
        gh<_i34.GetMomentsUseCase>(),
        gh<_i9.GetMonthUseCase>(),
        gh<_i10.GetYearUseCase>(),
        gh<_i45.DeleteMomentsUseCase>(),
...
class _$AppModules extends _i48.AppModules {}
