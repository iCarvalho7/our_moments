...
import '../modules/moment/domain/repository/moment_repository.dart' as _i22;
import '../modules/moment/domain/use_case/delete_moments_use_case.dart' as _i27;
import '../modules/moment/domain/use_case/get_moments_use_case.dart' as _i21;
import '../modules/moment/domain/use_case/register_moments_use_case.dart'
    as _i24;
import '../modules/moment/domain/use_case/update_moment_use_case.dart' as _i25;
...
import '../modules/moment/infra/repository/register_moment_repository_impl.dart'
    as _i23;
import '../modules/moment/presenter/bloc/add_or_edit_moment_bloc.dart' as _i26;
import '../modules/moment/presenter/bloc/photos_bloc.dart' as _i7;
import '../modules/photos/domain/repository/photos_repository.dart' as _i14;
import '../modules/photos/domain/use_case/delete_all_photos_from_moment_use_case.dart'
    as _i19;
import '../modules/photos/domain/use_case/delete_photo_use_case.dart' as _i20;
import '../modules/photos/domain/use_case/upload_photo_use_case.dart' as _i18;
import '../modules/photos/external/firebase_storage_photo_data_source.dart'
    as _i13;
import '../modules/photos/infra/data_source/photo_data_source.dart' as _i12;
import '../modules/photos/infra/repository/photos_repository_impl.dart' as _i15;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i19.ClearAllPhotosFromMomentUseCase>(
      () => _i19.ClearAllPhotosFromMomentUseCase(gh<_i14.PhotosRepository>()));
  gh.factory<_i20.DeletePhotoUseCase>(
      () => _i20.DeletePhotoUseCase(gh<_i14.PhotosRepository>()));
  gh.factory<_i21.GetMomentsUseCase>(
      () => _i21.GetMomentsUseCase(gh<_i16.TimeLineRepository>()));
  gh.factory<_i22.MomentRepository>(
      () => _i23.MomentRepositoryImpl(gh<_i10.MomentsDataSource>()));
  gh.factory<_i24.RegisterMomentsUseCase>(
      () => _i24.RegisterMomentsUseCase(gh<_i22.MomentRepository>()));
  gh.factory<_i25.UpdateMomentUseCase>(
      () => _i25.UpdateMomentUseCase(gh<_i22.MomentRepository>()));
  gh.factory<_i26.AddOrEditMomentBloc>(() => _i26.AddOrEditMomentBloc(
        gh<_i25.UpdateMomentUseCase>(),
        gh<_i24.RegisterMomentsUseCase>(),
        gh<_i18.UploadPhotoUseCase>(),
        gh<_i20.DeletePhotoUseCase>(),
      ));
  gh.factory<_i27.DeleteMomentsUseCase>(
      () => _i27.DeleteMomentsUseCase(gh<_i22.MomentRepository>()));
  gh.factory<_i28.TimeLineBloc>(() => _i28.TimeLineBloc(
        gh<_i21.GetMomentsUseCase>(),
        gh<_i5.GetMonthUseCase>(),
        gh<_i6.GetYearUseCase>(),
        gh<_i27.DeleteMomentsUseCase>(),
        gh<_i19.ClearAllPhotosFromMomentUseCase>(),
      ));
  return getIt;
}
